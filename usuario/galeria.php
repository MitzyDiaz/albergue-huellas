			...
			<?php
				...
				while($rw_banner_top=mysqli_fetch_array($sql_banner_top)){
					...
					<div class="col-lg-3 col-md-4 col-xs-6 thumb">
						...
						<a class="thumbnail" href="#" data-image-id="<?php echo $rw_banner_top['id'];?>"  data-toggle="modal" data-title="<?php echo $rw_banner_top['titulo'];?>" data-caption="<?php echo $rw_banner_top['id'];	?>" data-image="img/banner/<?php echo $rw_banner_top['url_image'];?>" data-target="#image-gallery">
