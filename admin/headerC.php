...
<header id="header">
        <nav class="menu">
            ...
            <div class="enlaces" id="enlaces">
                ...
                <a href="bannerlist.php"><i class="fas fa-dog"></i>Galeria</a>
                 <a href="aindex.php"><i class="fas fa-arrow-left"></i>Atrás</a>
                <a href="logout.php"><i class="fas fa-envelope"></i>Cerrar sesión</a>
            </div>
        </nav>
    </header>
