    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          ...
          <input type="text" class="form-control" id="validationCustom01" placeholder="Nombre (s)" value=""  required>
        </div>
        <div class="col-md-4 mb-3">
      ...
      <div class="form-group">
        ...
        <div class="col-md-4 mb-3">
          <label for="validationCustom01">Especifique</label>
          <input type="text" class="form-control" id="validationCustom01" placeholder="E.g: Perro, Gato..etc" value="" required>
        </div>
      ...
      <div class="row">
      <div class="col-md-10 mb-3">
          <label for="validationCustom03">Comprobante (INE)</label>
      ...
      <div class="col-md-10 mb-3">
          ...
          <div class="invalid-feedback">
            Por favor, escribe tu razón de adopción.
          </div>
      </div>
      </div>
      ...
      <div class="invalid-feedback">
        Debes de aceptar los terminos y condiciones para continuar
      </div>
      </div>
      

      <div class="row justify-content-center">
      <button type="button" class="btn btn-primary btn-lg " onclick="window.location='exito_form.php'">Enviar Formulario de Adopción</button>
      <a href="#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Enviar Formulario</a>
