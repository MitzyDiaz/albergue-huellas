<?php
	...
	function resultBlock($errors){
		if(count($errors) > 0)
		{
			...
			<a href='#' onclick=\"showHide('error');\">[Se encontraron errores al registrarse]</a>
			<ul>";
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'mitzy.diaz.valor@gmail.com';
		$mail->Password = 'mitzy1303';
		
		$mail->setFrom('mitzy.diaz.valor@gmail.com', 'Sistema Adopta una Huella');
